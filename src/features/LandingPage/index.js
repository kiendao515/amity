  ...
  return (
    <div className="min-vh-100 min-vw-90">
      ...
      <div className="bg-white">
                ...
                <div className="col-md-6 d-flex flex-column align-items-center align-items-md-start p-10">
                  <Fade left>
                    <h1>
                      ...
                      <span>
                        Enhancing African-Australian Belonging Online{" "}
                      </span>
                    </h1>
                    <p className="mt-5 mt-md-10 lh-lg">
                      This platform aims to unite the African-Australian
                      community by fostering genuine relationships and
                      understanding through curated user-generated content. By
                      transforming virtual interactions into meaningful
                      real-world connections, it seeks to bridge social and
                      cultural gaps, nurturing an authentic sense of belonging.
                    </p>
                    <div>
                      {!loggedIn ? (
        ...
        {/* Screen 2 */}
        <div
          className="Screen2 d-flex flex-column align-items-center"
          id="introduction"
        >
          <div
          ...
          >
            <Zoom>
              <h1 className="mt-20 mb-10">Meeting everyone online</h1>
            </Zoom>
            <Zoom delay={100}>
            ...
            <div className="d-flex w-100 justify-content-center justify-content-md-between p-5 p-sm-10 p-md-0 mt-md-30 mt-lg-40 mb-md-0 position-relative">
              <Zoom delay={400} duration={2000}>
                <img
                  ...
                  src={
                    "https://www.heart.org/-/media/Images/News/2019/March-2019/0306Neighborhoods_SC.png?h=600&w=800&hash=25F50A0B50125B16F1BDA218E708F791"
                  }
                  alt=""
                />
              </Zoom>
              <Zoom delay={400} duration={2000}>
                <img
                  className="ImgScreen2"
                  src={
                    "https://www.social-current.org/wp-content/uploads/2022/02/iStock-1341249027.jpg"
                  }
                  alt=""
                />
              </Zoom>
              <Zoom delay={400} duration={2000}>
                <img
                  ...
                  src={
                    "https://www.bentley.edu/sites/default/files/2023-02/shutterstock_1330772825_1224x821.jpg"
                  }
                  alt=""
                />
              </Zoom>
                  ...
                  <div className="Screen3-percent d-flex flex-column mt-10">
                    <Fade left delay={200}>
                      <div className="d-flex align-items-center py-5">
                        ...
                        các lập trình viên truy cập Amity mỗi ngày
                      </div>
                    </Fade>
                    <Fade left delay={300}>
                      <div className="d-flex align-items-center p-3 mt-6">
                        <h2 className="mx-5">81%</h2>
                        trong số các lập trình viên truy cập Amity ít nhất một
                        lần một tuần
                      </div>
                    </Fade>
                  </div>
        ...
        >
          <Zoom>
            ...
            >
              Blogs share about life
            </h1>
          </Zoom>
          <Zoom delay={100}>
            <p className="fs-5 mx-auto" style={{ color: "#5A7184" }}>
              Share with everyone about life, work, love...
            </p>
          </Zoom>
          <div className="ImgScreen4Wrapper d-flex my-15 mb-md-40 mx-auto position-relative">
            ...
            <Zoom delay={400}>
              <img
                className="ImgScreen4"
                src={
                  "https://img.freepik.com/free-photo/people-office-during-work-day_23-2150690162.jpg?size=626&ext=jpg&ga=GA1.1.1224184972.1715040000&semt=ais"
                }
                alt=""
              />
            </Zoom>
            <Fade bottom delay={500}>
              ...
              >
                ...
                <p className="text-center fw-bold">
                  Connect with people in a unique, conversational way
                </p>
              </div>
            </Fade>
            <Fade bottom delay={700}>
              ...
              >
                <i className="fas fa-check-circle"></i>
                <p className="text-center fw-bold">
                  More than 100 new posts every month
                </p>
              </div>
            </Fade>
              ...
              <div className="col-6 col-sm-4">
                <Fade bottom delay={500}>
                  ...
                  >
                    <i className="fas fa-check-circle"></i>
                    <p className="text-center fw-bold">
                      Kết nối với các lập trình viên theo cách trò chuyện, độc
                      đáo
                    </p>
                  </div>
                </Fade>
        ...
        <div className="Screen5 py-20">
          <div className="h-100 container-xl">
            <div className="row">
              ...
              <div className="col-md-6 d-flex flex-column align-items-start px-10">
                <Fade bottom>
                  <h1
                    className="mr-40"
                    style={{
                ...
                <Fade bottom delay={200}>
                  <div className="w-100">
                    ...
                    <label className="mt-10" id="LabelDrop1" htmlFor="touch1">
                      ...
                      <span>Amity traffic is large</span>
                    </label>
                    <div className="SlideText1">
                      On average, Amity receives more than 10.000 monthly
                      visits.
                    </div>
                  </div>
                </Fade>
                <Fade bottom delay={300}>
                  <div className="w-100">
                    ...
                    <label className="mt-6" id="LabelDrop2" htmlFor="touch2">
                      ...
                      <span>10 countries with the most traffic</span>
                    </label>
                    <div className="SlideText2">
                      Australia, USA, India, UK, Germany, Canada, France,
